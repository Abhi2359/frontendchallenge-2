...
import { ReactComponent as Close } from "../assets/images/icon-cart.svg";
import "./Product.css";
    ...
    <div className="product_page">
      <div className="image">
        ...
        <div className="larger_img">
          <img src={selectedImage} alt="product1"  onClick={handleProductClick}/>
        </div>
{isOpen&&(
  <div className="modal">
    <div className="modal-content">
    <img src={selectedImage} alt="product1" onClick={handleCloseClick} />
    </div>
  </div>
)}
