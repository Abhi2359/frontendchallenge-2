...
const Product = () => {
  ...
  const [image1Opacity ,setImageOpacity] =useState(1)
  const [image2Opacity ,setImageOpacity] =useState(1)
  const [image3Opacity ,setImageOpacity] =useState(1)
  const [image4Opacity ,setImageOpacity] =useState(1)
