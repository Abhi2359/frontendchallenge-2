...
import { ReactComponent as Cart } from "../assets/images/icon-cart2.svg";
import "./Product.css";
...
const Product = () => {
  ...
  return (
    <div className="product_page">
      ...
      <button onClick={handleDecremment} id="decrement"><Decrement/></button>
      <div class="counter">

          <p> {count}</p>
      </div>
      <button onClick={() => setCount(count + 1)}><Increment id="Increment"/></button>
          </div>
