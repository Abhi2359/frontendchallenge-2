    ...
    <div className="product_page">
      ...
      <div class="product_description">
        ...
        <div className="product_para">
          <p>These low-profile sneakers are your perfect casual wear <br/> comapnion.Featuring a durable rubber outer sole they'll <br/> withstand everything the weather canoffer</p>
        </div>
      </div>
    </div>
  );
