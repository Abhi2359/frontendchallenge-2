    ...
    <div className="product_page">
      ...
      <div class="product_description">
        ...
        <div className="product_para">
          <p>These low-profile sneakers are your perfect casual wear <br/> comapnion.Featuring a durable rubber outer sole they'll <br/> withstand everything the weather can offer.</p>
        </div>
        <div className="price">
          <h2>$125.00</h2>
          <div className="offer"><h3>50%</h3></div>
        </div>
        <div class="discount">
          <p className="strike">$250</p>
        </div>
      </div>
    </div>
  );
